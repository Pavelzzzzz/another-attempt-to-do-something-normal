package com.eva.another_attempt_to_do_something_normal.security.entity.dao.impl;

import com.eva.another_attempt_to_do_something_normal.hibernate.tables.TblSECPasswordEntity;
import com.eva.another_attempt_to_do_something_normal.hibernate.tables.TblSECRoleEntity;
import com.eva.another_attempt_to_do_something_normal.hibernate.tables.TblSECUserEntity;
import com.eva.another_attempt_to_do_something_normal.security.entity.UserSecurity;
import com.eva.another_attempt_to_do_something_normal.security.entity.dao.UserSecurityDao;
import com.eva.another_attempt_to_do_something_normal.service.entity.Role;
