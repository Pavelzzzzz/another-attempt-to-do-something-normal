...
import com.pavelzzzzz.another_attempt_to_do_something_normal.hibernate.tables.QTblSERLanguageEntity;
...
public interface TblSERLanguageEntityDao
    ...
    TblSERLanguageEntity getUserByLanguageId(int languageId);
    TblSERLanguageEntity getUserByIsoCode(String isoCode);
